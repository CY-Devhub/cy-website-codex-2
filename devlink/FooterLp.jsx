...
import _styles from "./FooterLp.module.css";

export function FooterLp({ as: _Component = _Builtin.Section }) {
  return (
    <_Component
      className={_utils.cx(_styles, "footer-lp")}
      grid={{
        type: "section",
      }}
      tag="section"
          ...
          >
            ...
            >
              <_Builtin.Block
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-_73ad6d9f-c6ee-e3e2-e756-0a7454eab28a-54eab284"
                )}
                tag="div"
              >
              ...
              <_Builtin.Grid
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-_73ad6d9f-c6ee-e3e2-e756-0a7454eab2a2-54eab284"
                )}
                tag="div"
              >
                <_Builtin.Block
                  className={_utils.cx(_styles, "uui-footer03_link-list-copy")}
                  tag="div"
                >
                  <_Builtin.Link
              ...
              <_Builtin.Block
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-_73ad6d9f-c6ee-e3e2-e756-0a7454eab2aa-54eab284"
                )}
                tag="div"
              >
                <_Builtin.Image
                  className={_utils.cx(_styles, "image-49")}
                  id={_utils.cx(
                    _styles,
                    "w-node-_73ad6d9f-c6ee-e3e2-e756-0a7454eab2ab-54eab284"
                  )}
                  width="auto"
                  height="auto"
                  loading="lazy"
                ...
                />
                <_Builtin.Image
                  className={_utils.cx(_styles, "image-47")}
                  width="auto"
                  height="auto"
                  loading="lazy"
                  alt=""
                  src="https://cdn.prod.website-files.com/6548c6e5ab9a929dbb64e897/654b5edc93dd10fac0f99e0a_ce-4-logo-png-transparent.png"
                />
                <_Builtin.Image
                  className={_utils.cx(_styles, "image-114")}
                  id={_utils.cx(
                    _styles,
                    "w-node-_73ad6d9f-c6ee-e3e2-e756-0a7454eab2ad-54eab284"
                  )}
                  width="auto"
                  height="auto"
                  loading="lazy"
                ...
                <_Builtin.Image
                  ...
                  id={_utils.cx(
                    _styles,
                    "w-node-_73ad6d9f-c6ee-e3e2-e756-0a7454eab2ae-54eab284"
                  )}
                  width="auto"
                  height="auto"
                  loading="lazy"
