...
import _styles from "./SliderReferenceSection.module.css";
...
export function SliderReferenceSection({
  ...
  sliderReferenceSectionId = "Slider-Reference-Section",
  sliderReferenceSectionPractises = "Slider-Reference-Section",
  referenceSlideContainer,
  practisesCollectionList3Id,
  practisesCollectionListWrapper3Id,
}) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "sliderreferencesection")}
      grid={{
        type: "section",
      }}
      tag="section"
      id={sliderReferenceSectionPractises}
    >
