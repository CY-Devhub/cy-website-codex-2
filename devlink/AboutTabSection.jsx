...
import _styles from "./AboutTabSection.module.css";

export function AboutTabSection({ as: _Component = _Builtin.Section }) {
  return (
    <_Component
      className={_utils.cx(_styles, "aboutcureositysection")}
      grid={{
        type: "section",
      }}
      tag="section"
      ...
      >
        ...
        >
          <_Builtin.TabsPane tag="div" data-w-tab="Tab 1">
            <_Builtin.RichText
              className={_utils.cx(_styles, "paragraph-1", "align-left")}
              tag="div"
              slot=""
            >
              <_Builtin.Paragraph>
